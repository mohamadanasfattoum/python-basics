...
__all__ = [
    ...
    'DISPID_SGRSTPropertyValue', 'SRADynamic', 'DISPID_SPACommit',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPEDisplayAttributes',
    'DISPID_SpeechPhraseAlternates', 'SVEBookmark',
    'DISPID_SRCCreateGrammar', 'IEnumString', 'ISpXMLRecoResult',
    'DISPID_SpeechRecoResult2', 'DISPID_SVEVoiceChange',
    'DISPID_SVESentenceBoundary', 'DISPID_SVEAudioLevel',
    'Speech_Default_Weight', 'SPBOOKMARKOPTIONS',
    'DISPID_SPRNumberOfElements', 'SREPhraseStart', 'SFTInput',
    'SVP_8', 'SPFM_CREATE', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFTCCITT_uLaw_22kHzMono', 'SSTTTextBuffer', 'ISpRecognizer',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpObjectWithToken',
    'SpWaveFormatEx', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechPhoneConverter', 'SPAUDIOOPTIONS', 'SPEVENTENUM',
    'SpCompressedLexicon', 'SPEI_TTS_PRIVATE', 'SPEI_RESERVED6',
    'DISPID_SVDisplayUI', 'eLEXTYPE_RESERVED10', 'SPWF_SRENGINE',
    'DISPID_SPIEnginePrivateData', 'DISPID_SABIEventBias', 'SASStop',
    'ISpeechRecoResult2', 'SpeechGrammarTagDictation',
    'DISPID_SPIProperties', 'SPBO_NONE', 'SP_VISEME_20',
    'DISPID_SRRGetXMLResult', 'SAFT44kHz8BitStereo',
    'SPCT_SUB_DICTATION', 'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_17',
    'SRATopLevel', 'DISPID_SLWLangId', 'SPEVENTSOURCEINFO',
    'DISPID_SPIReplacements', 'SPPS_LMA', 'SPEI_RESERVED2',
    'SPVPRIORITY', 'DISPID_SGRSTType', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechPhraseAlternate', 'SP_VISEME_10', 'eLEXTYPE_PRIVATE3',
    'SP_VISEME_4', 'SpeechCategoryRecoProfiles', 'SLTUser',
    'SDA_Two_Trailing_Spaces', 'SRTExtendableParse',
    'DISPID_SpeechPhraseReplacement', 'eLEXTYPE_PRIVATE18',
    'SPAS_CLOSED', 'SVP_5', 'DISPID_SPCIdToPhone', 'SDTRule',
    'DISPID_SVSLastResult', 'SREPropertyStringChange',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechAudioStatus',
    'DISPID_SPIRule', 'SAFTGSM610_11kHzMono', 'SpeechVisemeType',
    'SAFTGSM610_44kHzMono', 'SPRULE', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SGRsAdd', 'SPWAVEFORMATTYPE', 'SPLO_STATIC',
    'SpeechAddRemoveWord', 'SSSPTRelativeToStart',
    'DISPID_SpeechPhraseElement', 'DISPID_SPIGetText',
    'SAFT32kHz8BitMono', 'DISPID_SRCCreateResultFromMemory',
    'SPGS_DISABLED', 'DISPID_SpeechPhraseReplacements', 'SPWORDLIST',
    'DISPID_SGRSTText', 'ISpShortcut', 'SGDSActiveWithAutoPause',
    'DISPID_SRCVoicePurgeEvent', 'SITooSlow', 'SVP_3',
    'STCRemoteServer', 'SpeechAudioState', 'SPDATAKEYLOCATION',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SAStatus', 'SpAudioFormat',
    'SGRSTTRule', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechCustomStream',
    'SPAO_NONE', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPPNumberOfElements', 'SpLexicon', 'eLEXTYPE_PRIVATE10',
    'SPADAPTATIONRELEVANCE', 'ISpeechPhraseProperty', 'SP_VISEME_5',
    'SP_VISEME_13', 'SP_VISEME_15', 'DISPID_SRCResume',
    'DISPID_SGRSTRule', 'DISPID_SVSpeak', 'SAFTADPCM_8kHzStereo',
    'SPEI_VISEME', 'SPSVerb', 'SREInterference', 'SVSFIsFilename',
    'SWPUnknownWordUnpronounceable', 'SpeechWordType',
    'SpeechRunState', 'SPPARTOFSPEECH', 'SpMMAudioIn',
    'DISPID_SGRsCommitAndSave', 'DISPID_SRCEHypothesis',
    'DISPID_SPRulesCount', 'SpeechCategoryAudioIn',
    'DISPID_SPERetainedSizeBytes', 'SpSharedRecoContext',
    'SAFTADPCM_22kHzStereo', 'SBOPause', 'SDTLexicalForm',
    'SpeechDataKeyLocation', 'SPCATEGORYTYPE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPRuleId',
    'SpeechTokenValueCLSID', 'SGDSActiveUserDelimited', 'SREPrivate',
    'Speech_Max_Pron_Length', 'SPEI_REQUEST_UI', 'ISpeechRecognizer',
    'SpPhoneticAlphabetConverter',
    'DISPID_SRCERecognitionForOtherContext', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SpeechLexicon', 'SpeechRuleAttributes',
    'ISpeechObjectToken', 'SDTReplacement',
    'DISPID_SOTGetStorageFileName', 'SVP_13',
    'SpeechRecoProfileProperties', 'DISPID_SPCLangId',
    'SPSHT_NotOverriden', 'DISPID_SPRuleName',
    'DISPID_SRRSaveToMemory', 'ISpeechPhraseReplacements',
    'eWORDTYPE_DELETED', 'DISPID_SRGIsPronounceable',
    'DISPID_SOTIsUISupported', 'eWORDTYPE_ADDED',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SVEventInterests', 'SpNullPhoneConverter', 'SP_VISEME_7',
    'DISPID_SPPChildren', 'DISPID_SLRemovePronunciation',
    'SpeechAudioFormatType', 'DISPID_SPRText', 'eLEXTYPE_PRIVATE12',
    'SPFM_OPEN_READONLY', 'DISPID_SWFEChannels',
    'DISPID_SRRPhraseInfo', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SWTDeleted', 'ISpeechPhraseInfo', 'SPRULESTATE',
    'eLEXTYPE_RESERVED8', 'DISPID_SDKEnumValues',
    'ISpeechAudioBufferInfo', 'SPCT_SLEEP', 'SpeechTokenShellFolder',
    'SpeechGrammarWordType', 'DISPID_SOTCreateInstance', 'SRARoot',
    'DISPID_SLPType', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRCEInterference',
    'DISPID_SpeechXMLRecoResult', 'SpUnCompressedLexicon',
    'SRESoundEnd', 'SAFT12kHz8BitStereo', 'SPGRAMMARSTATE',
    'SGRSTTEpsilon', 'DISPID_SpeechBaseStream',
    'DISPID_SRGetRecognizers', 'SPLEXICONTYPE', 'SpeechVisemeFeature',
    'ISpProperties', 'ISpLexicon', 'DISPID_SpeechGrammarRules',
    'SAFT32kHz16BitMono', 'eLEXTYPE_VENDORLEXICON', 'SPCONTEXTSTATE',
    'SRAORetainAudio', 'DISPID_SGRAddResource', 'eLEXTYPE_APP',
    'SVSFNLPSpeakPunc', 'DISPID_SREmulateRecognition',
    'SREStateChange', 'DISPID_SGRSTsItem', 'DISPID_SPEDisplayText',
    'SVP_12', 'DISPID_SVEWord', 'DISPID_SVStatus',
    'DISPID_SRSNumberOfActiveRules', 'SVSFParseSapi',
    'DISPID_SPARecoResult', 'DISPID_SpeechVoice',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVP_6',
    'SPXMLRESULTOPTIONS', 'SAFTCCITT_ALaw_22kHzStereo',
    'SSFMOpenReadWrite', 'SP_VISEME_19', 'SVP_20',
    'DISPID_SpeechPhraseProperties', 'SPVPRI_OVER',
    'SpeechVoiceSpeakFlags', 'SVP_1', 'SP_VISEME_9',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SOTId',
    'SPRST_ACTIVE_ALWAYS', 'SINoSignal', 'DISPID_SVWaitUntilDone',
    'DISPID_SVGetProfiles', 'ISpeechAudio', 'SASRun',
    'SAFT48kHz16BitMono', 'SP_VISEME_8', 'DISPID_SABufferInfo',
    'DISPID_SPPName', 'SRTReSent', 'DISPID_SpeechRecognizerStatus',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_MAX_SR',
    'SPWT_LEXICAL', 'SpeechTokenKeyUI', 'SPEI_VOICE_CHANGE',
    'SPGS_ENABLED', 'SpeechPropertyAdaptationOn',
    'ISpeechPhraseReplacement', 'SPEI_RESERVED5', 'SPPROPERTYINFO',
    'ISpeechRecoContext', 'DISPID_SGRId', 'DISPID_SGRAttributes',
    'eLEXTYPE_PRIVATE8', 'SRTSMLTimeout',
    'ISpPhoneticAlphabetSelection', 'SSTTDictation',
    'DISPID_SPRules_NewEnum', 'DISPID_SPPValue', 'SPFM_NUM_MODES',
    'eLEXTYPE_RESERVED4', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SOTsItem', 'SWPKnownWordPronounceable',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SWFEBitsPerSample',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SMSSetData', 'SLTApp',
    'eLEXTYPE_PRIVATE5', 'ISpeechGrammarRuleStateTransition',
    'STSF_LocalAppData', 'DISPID_SDKCreateKey',
    'DISPID_SVSLastBookmarkId', 'SGDisplay', 'SAFT24kHz8BitMono',
    'SAFT48kHz16BitStereo', 'ISpRecoCategory',
    'DISPID_SpeechLexiconWords', 'SPLO_DYNAMIC',
    'SAFT32kHz8BitStereo', 'DISPID_SPEs_NewEnum',
    'DISPID_SRIsUISupported', 'SPDKL_LocalMachine', 'SINoise',
    'DISPID_SPEAudioTimeOffset', 'SRSInactive',
    'DISPID_SpeechVoiceEvent', 'SPWORDPRONUNCIATION',
    'SDTPronunciation', 'SVEWordBoundary', 'SpeechLoadOption',
    'ISpeechLexiconWords', 'DISPID_SRCRequestedUIType',
    '__MIDL_IWinTypes_0009', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SVRate',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRsFindRule', 'SPSModifier',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRSetPropertyNumber', 'SVSFParseMask',
    'DISPID_SABIBufferSize', 'DISPID_SpeechGrammarRule',
    'SPRECOGNIZERSTATUS', 'DISPID_SAFGetWaveFormatEx',
    'SPEI_SR_RETAINEDAUDIO', 'SpMemoryStream', 'SAFT8kHz16BitMono',
    'DISPID_SRIsShared', 'ISpeechObjectTokenCategory',
    'SAFT12kHz8BitMono', 'SRADefaultToActive', 'DISPID_SLWWord',
    'UINT_PTR', 'SPSNotOverriden', 'DISPID_SMSAMMHandle',
    'DISPID_SRStatus', 'SRCS_Disabled',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVEBookmark', 'SAFTGSM610_8kHzMono', 'ISpeechLexiconWord',
    'DISPID_SOTRemove', 'SpeechGrammarTagWildcard', 'STSF_AppData',
    'ISpeechDataKey', 'SGSDisabled', 'DISPID_SVVoice',
    'DISPID_SVIsUISupported', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SLAddPronunciation', 'DISPID_SRCEAdaptation',
    'SPPHRASEELEMENT', 'SVPOver', 'DISPID_SRRSpeakAudio',
    'SPWORDPRONOUNCEABLE', 'SpeechCategoryRecognizers',
    'DISPID_SLWsCount', 'DISPID_SRGRecoContext',
    'ISpeechObjectTokens', 'eLEXTYPE_PRIVATE6', 'DISPID_SLWsItem',
    'SDTAudio', 'SPEI_START_SR_STREAM', 'DISPID_SLPPhoneIds',
    'DISPID_SRGetPropertyString', 'SPSHORTCUTTYPE',
    'SAFT44kHz16BitStereo', 'DISPID_SWFEExtraData',
    'DISPID_SPERetainedStreamOffset', 'SAFTCCITT_uLaw_11kHzStereo',
    'WAVEFORMATEX', 'SPSTREAMFORMATTYPE', 'SAFT32kHz16BitStereo',
    ...
    'SPEI_SR_BOOKMARK', 'SPDKL_DefaultLocation', 'SINone',
    ...
    'DISPID_SRDisplayUI', 'DISPID_SVSRunningState',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVPause', 'SVP_14',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SDTDisplayText',
    'DISPID_SPEsCount', 'DISPID_SRCVoice', 'DISPID_SRCRetainedAudio',
    'SPSHORTCUTPAIRLIST', 'DISPID_SOTCSetId', 'DISPID_SAFType',
    'DISPID_SPERequiredConfidence', 'ISpEventSink', 'DISPID_SBSWrite',
    'IInternetSecurityMgrSite', 'STCInprocServer', 'SPBO_TIME_UNITS',
    'SVESentenceBoundary', 'DISPID_SRGetFormat',
    ...
    'DISPID_SPRsItem', 'DISPID_SPEActualConfidence',
    'SpeechRegistryLocalMachineRoot', 'SVP_15', 'SVP_11',
    'SAFT11kHz16BitMono', 'SRSActiveAlways', 'IStream',
    'SpeechGrammarState', 'DISPID_SVEStreamStart',
    'DISPID_SLGetWords', 'DISPID_SRSSupportedLanguages',
    'ISpStreamFormat', 'SPEI_SR_AUDIO_LEVEL', '_SPAUDIOSTATE',
    ...
    'SITooFast', 'SGLexical', 'LONG_PTR',
    'SpeechStreamSeekPositionType', 'SVSFParseAutodetect',
    'DISPID_SFSClose', 'SPPHRASEREPLACEMENT', 'SBONone', 'tagSTATSTG',
    'DISPID_SLGetPronunciations', 'SVEVoiceChange',
    'SDA_No_Trailing_Space', 'SPEI_RESERVED1', 'SP_VISEME_21',
    'ISpeechLexiconPronunciation', 'DISPID_SLPLangId',
    'SECHighConfidence', 'ISpeechWaveFormatEx',
    'SPRS_ACTIVE_USER_DELIMITED', 'SGDSInactive', 'SECFIgnoreWidth',
    'DISPID_SpeechRecoContext', 'eLEXTYPE_PRIVATE7', 'SP_VISEME_12',
    'DISPID_SPIEngineId', 'ISpNotifyTranslator',
    'SpeechRecognitionType', 'SPDKL_CurrentUser',
    'SpeechVoicePriority', 'SREAdaptation', 'SAFT48kHz8BitMono',
    'SVSFDefault', 'SPSUnknown', 'DISPID_SPIGrammarId',
    'ISpeechResourceLoader', 'SP_VISEME_1', 'DISPID_SLPSymbolic',
    'DISPID_SDKGetBinaryValue', 'SGLexicalNoSpecialChars',
    'DISPID_SVSVisemeId', 'eLEXTYPE_PRIVATE4',
    'SpeechPropertyNormalConfidenceThreshold', 'SDTProperty',
    'SVPAlert', 'DISPID_SRRDiscardResultInfo', 'DISPID_SPAPhraseInfo',
    'DISPID_SASCurrentDevicePosition', 'SLOStatic',
    'SPPS_Interjection', 'DISPID_SPPEngineConfidence',
    'ISpeechLexicon', 'SpeechTokenContext',
    'DISPID_SPAStartElementInResult', 'DISPID_SBSSeek', 'SpStream',
    'SDTAlternates', 'SPINTERFERENCE_TOOQUIET', 'SPAR_Unknown',
    'ISpeechRecognizerStatus', 'ISpeechPhraseRules',
    'DISPID_SRRTTickCount', 'SAFTCCITT_uLaw_8kHzMono',
    'SpSharedRecognizer', 'DISPID_SPRuleParent',
    'SRERecoOtherContext', 'SREAllEvents',
    'DISPID_SPRuleFirstElement', 'SPXRO_Alternates_SML',
    'eLEXTYPE_PRIVATE1', 'SPAO_RETAIN_AUDIO', 'DISPID_SRCESoundStart',
    'SPEI_MAX_TTS', 'SRSEDone', 'eLEXTYPE_PRIVATE9', 'SVP_21',
    'DISPID_SpeechFileStream', 'SpeechSpecialTransitionType',
    'SPINTERFERENCE_NOISE', 'SAFTExtendedAudioFormat',
    'DISPID_SPELexicalForm', 'DISPID_SRCEFalseRecognition',
    'SSSPTRelativeToEnd', 'DISPID_SWFEBlockAlign',
    'SAFT16kHz16BitMono', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRCEEndStream', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechAudioFormat',
    'SPINTERFERENCE_NONE', 'SPSFunction', 'SPEI_PHONEME',
    'DISPID_SLWPronunciations', 'DISPID_SDKGetStringValue',
    'DISPID_SAFGuid', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPRuleChildren', 'SPSNoun', 'SPBO_PAUSE', 'SVSFIsNotXML',
    'SPAS_PAUSE', 'DISPID_SpeechMemoryStream', 'DISPID_SRCBookmark',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPINTERFERENCE_TOOFAST',
    'SPSEMANTICFORMAT', 'DISPID_SLPsItem', 'SVF_None', 'SGSExclusive',
    'DISPID_SGRSTPropertyId', 'DISPID_SLGenerationId',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRGetPropertyNumber', 'DISPID_SASState',
    'SPPHRASEPROPERTY', 'SPRECOSTATE', 'DISPID_SGRName',
    'SRESoundStart', 'DISPID_SpeechObjectToken', 'SVF_Stressed',
    'SECLowConfidence', 'DISPID_SRCEventInterests', 'SGRSTTWildcard',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SOTDisplayUI',
    'SRERequestUI', 'ISpeechRecoResultDispatch', 'SVP_16',
    'SPEI_MIN_SR', 'SVF_Emphasis', 'SVP_4', 'SVSFUnusedFlags',
    'DISPID_SpeechVoiceStatus', 'DISPID_SVSpeakStream',
    'SpeechCategoryAudioOut', 'DISPID_SRState',
    'DISPID_SRGSetWordSequenceData', 'SGRSTTTextBuffer',
    'SREBookmark', 'SpeechPartOfSpeech', 'SpeechBookmarkOptions',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_WORD_BOUNDARY', 'SVEPrivate', 'SAFT22kHz8BitMono',
    'SAFT22kHz16BitMono', 'DISPID_SOTMatchesAttributes',
    'SDKLCurrentConfig', 'ISpeechGrammarRules', 'SPINTERFERENCE',
    'SVP_0', 'SVEAudioLevel', 'SpeechDictationTopicSpelling',
    'IInternetSecurityManager', 'SRERecognition', 'SPFILEMODE',
    'SDA_One_Trailing_Space', 'SPWF_INPUT', 'DISPID_SRGId',
    'DISPID_SGRsDynamic', 'SPPS_RESERVED3', 'ISpeechMMSysAudio',
    'DISPID_SPEEngineConfidence', 'SpeechFormatType', 'SP_VISEME_18',
    'DISPID_SRGCmdLoadFromFile', 'SGPronounciation', 'SPSMF_UPS',
    'DISPID_SFSOpen', 'STSF_CommonAppData', 'DISPID_SGRsCommit',
    'ISpeechPhraseElements', 'DISPID_SRGDictationLoad',
    'SPPS_NotOverriden', 'DISPID_SOTCGetDataKey', 'SVSFNLPMask',
    'eLEXTYPE_PRIVATE11', 'eLEXTYPE_USER_SHORTCUT',
    'SpeechRecoEvents', 'SVP_7', 'DISPID_SpeechLexiconProns',
    'DISPID_SPRs_NewEnum', 'ISpResourceManager',
    'DISPID_SVAudioOutputStream', 'DISPID_SPPId',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechPhraseProperties',
    'DISPID_SPIRetainedSizeBytes', 'ISpeechPhraseAlternates',
    'ISpMMSysAudio', 'SAFTDefault', 'SpeechStreamFileMode',
    'SpCustomStream', 'ISpEventSource', 'DISPID_SPEPronunciation',
    'DISPID_SDKSetBinaryValue', 'SPRS_INACTIVE',
    'SAFT8kHz16BitStereo', 'DISPID_SVGetVoices',
    'DISPID_SDKSetLongValue', 'SFTSREngine', 'DISPID_SPPs_NewEnum',
    'SpeechEmulationCompareFlags', 'DISPID_SLWs_NewEnum',
    'ISequentialStream', 'SpeechAudioFormatGUIDText', 'SPAS_STOP',
    'SPEVENT', 'SPSHORTCUTPAIR', 'DISPID_SPIAudioSizeTime',
    'SVSFIsXML', 'DISPID_SRGRules', 'SVSFParseSsml',
    'DISPID_SWFESamplesPerSec', 'SVP_19', 'SPXRO_SML', 'SPPHRASE',
    'SPWORD', 'DISPID_SRRSetTextFeedback', 'SREStreamEnd',
    'SPEI_SR_PRIVATE', 'SVP_9', 'SPPHRASERULE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPILanguageId',
    'SP_VISEME_14', 'DISPID_SRCState', 'SpeechAudioProperties',
    'SVP_2', 'DISPID_SPAsItem', 'ISpeechRecoResultTimes',
    'SpInProcRecoContext', 'ISpAudio', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPEsItem', 'DISPID_SRGCmdLoadFromObject',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechDataKey',
    'ISpStreamFormatConverter', 'eLEXTYPE_PRIVATE13',
    'SpeechMicTraining', 'DISPID_SLPPartOfSpeech',
    'DISPID_SPRulesItem', 'DISPID_SASCurrentSeekPosition',
    'SpeechTokenIdUserLexicon', 'SPAS_RUN', 'DISPID_SOTDataKey',
    'ISpPhoneticAlphabetConverter',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRGCmdLoadFromMemory',
    'STCInprocHandler', 'SPWT_PRONUNCIATION',
    'SpeechPropertyResponseSpeed', 'ISpeechCustomStream',
    'DISPID_SRAudioInput', 'DISPID_SGRSTWeight', 'eLEXTYPE_PRIVATE2',
    'DISPID_SDKGetlongValue', 'DISPID_SPIAudioSizeBytes', 'SWTAdded',
    'SVEPhoneme', 'DISPID_SRRAudioFormat', 'SPEI_HYPOTHESIS',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_RESERVED6',
    'SREPropertyNumChange', 'DISPID_SPPBRestorePhraseFromMemory',
    'SRCS_Enabled', 'SpObjectToken', 'SVSFlagsAsync',
    'SGRSTTDictation', 'SPRST_ACTIVE', 'DISPID_SGRAddState', 'SVP_10',
    'SPRECORESULTTIMES', 'SpeechAudioFormatGUIDWave',
    'DISPID_SBSFormat', 'SRSEIsSpeaking', 'DISPID_SOTs_NewEnum',
    'SpPhoneConverter', 'SSFMOpenForRead', 'SVEEndInputStream',
    'DISPID_SpeechRecognizer', 'SAFT12kHz16BitMono',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SGRsCount', 'DISPID_SMSALineId', 'DISPID_SRCEAudioLevel',
    'ISpRecoGrammar2', 'SAFT11kHz16BitStereo',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechAudio',
    'SpStreamFormatConverter', 'SAFTGSM610_22kHzMono', 'ISpeechVoice',
    'SP_VISEME_0', 'DISPID_SVEEnginePrivate', 'SVPNormal',
    'DISPID_SRProfile', 'ISpeechAudioStatus', 'ISpeechAudioFormat',
    'SECFEmulateResult', 'DISPID_SRCERecognition',
    'DISPID_SPRuleConfidence', 'DISPID_SVPriority', 'SDKLCurrentUser',
    'eLEXTYPE_RESERVED9', 'DISPID_SPANumberOfElementsInResult',
    'ISpeechVoiceStatus', 'DISPID_SVSCurrentStreamNumber',
    'ISpeechPhoneConverter', 'ISpRecoGrammar', 'DISPID_SVEPhoneme',
    'SPEI_ADAPTATION', 'SPPS_Unknown', 'SVEStartInputStream',
    'SPCT_SUB_COMMAND', 'ISpeechPhraseElement', 'SPRST_INACTIVE',
    'SPSHT_Unknown', 'SSTTWildcard', 'SPAUDIOSTATUS',
    'DISPID_SGRSTNextState', 'SAFT22kHz16BitStereo',
    'SPSMF_SAPI_PROPERTIES', 'SPSInterjection',
    'DISPID_SRRAlternates', 'SGDSActive', 'eLEXTYPE_PRIVATE14',
    'DISPIDSPTSI_ActiveLength', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPPsItem', 'SRAExport', 'SP_VISEME_3', 'SVEViseme',
    'DISPID_SPPParent', 'DISPID_SRGCmdSetRuleIdState',
    'ISpObjectTokenCategory', 'SPEI_SOUND_START', 'DISPID_SVEViseme',
    'SpeechEngineConfidence', 'ISpRecognizer3',
    'Speech_StreamPos_Asap', 'SAFTADPCM_44kHzMono', 'SPVPRI_NORMAL',
    'DISPID_SVSInputWordPosition', 'SDKLDefaultLocation',
    'DISPID_SpeechPhraseProperty', 'SPBO_AHEAD',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SOTsCount',
    'SpInprocRecognizer', 'SGSEnabled', 'SPPS_RESERVED1',
    'SpeechCategoryVoices', 'DISPID_SGRSRule', 'ISpeechPhraseRule',
    'DISPID_SRCreateRecoContext', 'ISpNotifySink', 'SASClosed',
    'SWPUnknownWordPronounceable', 'SPVOICESTATUS',
    'SPEI_INTERFERENCE', 'DISPID_SpeechPhraseElements',
    'DISPID_SRRecognizer', 'SAFT16kHz8BitMono', 'DISPID_SPPsCount',
    'DISPID_SRRTimes', 'SpeechRecoContextState', 'STSF_FlagCreate',
    'ISpRecoContext', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPAUDIOBUFFERINFO', 'SRTEmulated', 'SPRST_INACTIVE_WITH_PURGE',
    ...
    'SpFileStream', 'ISpeechBaseStream', 'DISPID_SRCPause',
    'SpeechRecognizerState', 'SPPS_RESERVED4', 'SRAInterpreter',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRRTLength',
    'STCLocalServer', 'DISPID_SRGReset', 'DISPID_SRGDictationUnload',
    'SpeechCategoryAppLexicons', 'DISPIDSPTSI_SelectionOffset',
    'SVEAllEvents', 'SpeechRuleState', 'SPPS_Noun', 'SITooQuiet',
    'SAFT24kHz8BitStereo', 'ISpPhraseAlt', 'SECFNoSpecialChars',
    'SpMMAudioEnum', 'DISPID_SVSPhonemeId', 'DISPID_SRGState',
    'DISPID_SDKEnumKeys', 'SAFT12kHz16BitStereo', 'SPVPRI_ALERT',
    'SPCT_COMMAND', 'SPSHT_EMAIL',
    ...
    '_ISpeechRecoContextEvents', 'SPPS_Noncontent', 'DISPID_SRRAudio',
    'SPPS_RESERVED2', 'ISpeechXMLRecoResult',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPAsCount', 'SPAR_High',
    'DISPID_SpeechLexiconWord', 'DISPID_SRSetPropertyString',
    'DISPID_SpeechPhraseRule', 'SREFalseRecognition',
    'DISPID_SMSGetData', 'SPAR_Medium', 'SAFTText',
    'DISPID_SVGetAudioOutputs', 'SP_VISEME_2', 'SPRST_NUM_STATES',
    'SpeechLexiconType', 'SRSInactiveWithPurge',
    'SpeechPropertyHighConfidenceThreshold', 'ISpObjectToken',
    'IEnumSpObjectTokens', 'eLEXTYPE_MORPHOLOGY',
    'eLEXTYPE_PRIVATE16', 'ISpPhrase', 'DISPID_SRRGetXMLErrorInfo',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechVoiceSkipTypeSentence',
    'DISPIDSPRG', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVAudioOutput', 'SGRSTTWord', 'DISPID_SRSClsidEngine',
    'SPBINARYGRAMMAR', 'SPEI_PHRASE_START', 'SPFM_CREATE_ALWAYS',
    'SpTextSelectionInformation', 'SSFMCreate', 'DISPID_SLWType',
    'SAFT22kHz8BitStereo', 'ISpStream', 'DISPID_SRRTStreamTime',
    'DISPID_SRCESoundEnd', 'SPEI_RESERVED3',
    'DISPID_SRGSetTextSelection', 'DISPID_SPRDisplayAttributes',
    'SPCS_ENABLED', 'SRTStandard', 'ISpeechMemoryStream',
    'SVSFPersistXML', 'ISpRecoResult', 'DISPID_SABIMinNotification',
    'SECFIgnoreKanaType', 'SAFT24kHz16BitStereo',
    'ISpeechGrammarRule', 'SREHypothesis', 'DISPID_SLPsCount',
    'SREAudioLevel', 'DISPID_SBSRead', 'SAFT24kHz16BitMono',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVSInputSentencePosition',
    'DISPID_SWFEFormatTag', '_ISpeechVoiceEvents',
    'SpeechTokenKeyAttributes', 'DISPID_SAVolume', 'SP_VISEME_16',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPSERIALIZEDPHRASE', 'SRAONone',
    'DISPID_SRCRecognizer', 'DISPID_SPPConfidence',
    'DISPID_SRGCommit', 'DISPID_SOTCId', 'SDKLLocalMachine',
    'SPPS_SuppressWord', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRCEBookmark', 'DISPID_SRCERequestUI',
    'eLEXTYPE_PRIVATE20', 'SPPS_Verb', 'SPEI_RECOGNITION',
    'SAFT8kHz8BitStereo', 'DISPID_SRCRetainedAudioFormat',
    'ISpNotifySource', 'SLODynamic', 'SECFIgnoreCase', 'SpMMAudioOut',
    'SAFTNonStandardFormat', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpNotifyTranslator', 'SAFTADPCM_8kHzMono',
    'DISPID_SRCERecognizerStateChange',
    'ISpeechLexiconPronunciations', 'DISPID_SVSInputWordLength',
    'SPWORDTYPE', 'SPRECOCONTEXTSTATUS', 'DISPID_SDKDeleteValue',
    'DISPID_SGRClear', 'DISPID_SpeechPhraseInfo',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechObjectTokens',
    'DISPID_SpeechRecoResult', 'SpeechInterference',
    'SAFT44kHz8BitMono', 'DISPID_SVSkip',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechTokenKeyFiles',
    'DISPID_SPAs_NewEnum', 'SpVoice', 'SpeechUserTraining',
    'DISPID_SPIStartTime', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpObjectTokenCategory', 'DISPID_SCSBaseStream',
    'DISPID_SpeechPhraseAlternate', 'SASPause', 'SPSEMANTICERRORINFO',
    'SRSActive', 'DISPID_SGRSTsCount', 'DISPID_SPRFirstElement',
    'ISpRecognizer2', 'SPCT_DICTATION', 'SVP_17',
    'SpeechPropertyResourceUsage', 'DISPID_SRCEStartStream',
    'SAFT11kHz8BitMono', 'SPSERIALIZEDRESULT',
    'DISPID_SOTGetAttribute', 'SVSFPurgeBeforeSpeak',
    'SPEI_SOUND_END', 'SAFTNoAssignedFormat', 'SREStreamStart',
    'ISpPhoneConverter', 'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE15',
    'SPSSuppressWord', 'SSFMCreateForWrite', 'SPRS_ACTIVE',
    'SECFDefault', 'ISpeechGrammarRuleStateTransitions',
    'SPSHT_OTHER', 'SpeechWordPronounceable', 'SPTEXTSELECTIONINFO',
    ...
    'DISPID_SMSADeviceId', 'eLEXTYPE_PRIVATE17',
    'DISPID_SpeechMMSysAudio', 'ISpeechFileStream',
    'DISPID_SPRsCount', 'SPVISEMES', 'DISPID_SPRuleEngineConfidence',
    ...
    'SP_VISEME_11', 'STCAll', 'SPGS_EXCLUSIVE', 'DISPID_SVResume',
    'SpeechAudioVolume', 'DISPID_SOTSetId',
    'DISPID_SGRSAddSpecialTransition', 'ISpSerializeState',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVAlertBoundary',
    'SAFT8kHz8BitMono', 'ISpRecoContext2', 'SpeechRegistryUserRoot',
    'SPSLMA', 'DISPID_SPISaveToMemory', 'SpResourceManager',
    'DISPID_SGRInitialState', 'SpeechDiscardType',
    'DISPID_SGRSTransitions', 'SECNormalConfidence',
    'SpPhraseInfoBuilder', 'SAFTCCITT_ALaw_11kHzMono',
    'SPEI_END_SR_STREAM', 'DISPID_SOTGetDescription',
    'DISPID_SGRsItem', 'SAFTADPCM_11kHzStereo',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpVoice', 'DISPID_SASNonBlockingIO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'tagSPTEXTSELECTIONINFO',
    'SPEI_END_INPUT_STREAM', 'SVP_18', 'SPPS_Modifier', 'SRAImport',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechRetainedAudioOptions', 'SpeechEngineProperties',
    'DISPID_SPIElements', 'DISPID_SVVolume',
    'DISPID_SpeechLexiconPronunciation', 'ISpeechRecoGrammar',
    'eLEXTYPE_RESERVED7', 'DISPID_SRCEPropertyNumberChange',
    'SpeechDisplayAttributes', 'ISpeechRecoResult', 'SPAR_Low',
    'ISpGrammarBuilder', 'SpShortcut', 'DISPID_SRRTOffsetFromStart',
    'SPPS_Function', 'SAFTADPCM_44kHzStereo', 'ISpDataKey',
    'SAFTADPCM_11kHzMono', 'SDTAll', 'DISPIDSPTSI',
    'DISPID_SAEventHandle', 'DISPID_SOTCDefault',
    'DISPID_SRCEPhraseStart', 'SPEI_RECO_STATE_CHANGE',
    'SAFT48kHz8BitStereo', 'SRTAutopause', 'SPAUDIOSTATE',
    'SPLOADOPTIONS', 'DISPID_SpeechRecoResultTimes',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SASetState',
    'DISPID_SPRuleNumberOfElements', 'SPDKL_CurrentConfig',
    'SPCS_DISABLED', 'tagSPPROPERTYINFO', 'DISPID_SVEStreamEnd',
    'SPEI_UNDEFINED', 'DISPID_SVSLastBookmark'
]

_check_version('1.2.0', 1700071545.616303)
